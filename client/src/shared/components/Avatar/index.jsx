...
import { Image, Letter, AnimeAvatarWrapper, AnimeAvatarInner } from './Styles';
...
const Avatar = ({ className, avatarUrl, name, size, variant, ...otherProps }) => {
  ...
  if (variant === 'anime') {
    return (
      <AnimeAvatarWrapper size={size} className={className} {...otherProps}>
        <AnimeAvatarInner size={size} avatarUrl={animeImage} />
      </AnimeAvatarWrapper>
    );
  }
