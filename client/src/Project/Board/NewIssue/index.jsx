...
const ProjectBoardNewIssue = ({ project, fetchProject }) => {
      ...
      >
        <FormElement>
          ...
          <Actions>
            ...
            <ActionButton type="button" variant="empty" onClick={handleGoBack}>
              Cancel
            </ActionButton>
          </Actions>
        </FormElement>
...
ProjectBoardNewIssue.propTypes = propTypes;

export default ProjectBoardNewIssue;
